  ...
  return (
    <label className="flex items-center gap-3 cursor-pointer group">
      <input
        ...
        className="w-5 h-5 rounded border-outline-variant bg-surface-container-lowest text-primary focus:ring-primary focus:ring-offset-0 focus:ring-offset-background"
      />
...
export default function SettingsPanel({ metrics, engine, onChange }: SettingsPanelProps) {
  ...
  return (
    ...
    >
      {/* Post & Reel Metrics */}
      <div className="surface-card rounded-xl p-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-md gap-x-lg">
      ...
      <div className="surface-card rounded-xl p-md">
        ...
        <MetricCheckbox
          label="Engagement Rate (Likes+Comments / Followers × 100)"
          ...
          <div>
            ...
            <div className="flex items-center gap-sm">
              <input
                ...
                className="w-full bg-surface-container-lowest border border-outline-variant rounded text-on-surface text-body-md focus:border-primary focus:ring-1 focus:ring-primary px-sm py-xs"
              />
      ...
      <div className="surface-card rounded-xl p-md">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-surface-container-lowest border border-outline-variant rounded text-on-surface text-body-md focus:border-primary focus:ring-1 focus:ring-primary px-sm py-sm appearance-none cursor-pointer"
          >
